...
export const en: Record<MessageKey, string> = {
  ...
  "home.tools.title": "Other tools",
  "home.tools.group.employee": "Employment",
  "home.tools.group.vat": "Self-employment",
  "home.tools.group.exit": "Leaving a job",
  "home.tools.group.time": "Money over time",
  "home.tools.group.reference": "Reference",
  "home.available.tredicesima.title": "Net 13th salary",
  "home.available.tredicesima.body": "What is left of the 13th salary after INPS and IRPEF.",
  "home.available.inverse.title": "Gross from net",
  "home.available.inverse.body": "The gross annual salary that produces the net you want.",
  "home.available.comparison.title": "Compare offers",
  "home.available.comparison.body": "Two gross salaries side by side, to see which one pays more.",
  "home.available.employerCost.title": "Cost of employment",
  "home.available.employerCost.body":
    "What an employee costs the company, from gross pay to contributions.",
  "home.available.tfr.title": "TFR",
  "home.available.tfr.body": "How much severance you build up and what the revaluation adds.",
  "home.available.apprenticeship.title": "Apprenticeship progression",
  "home.available.apprenticeship.body": "Pay year by year during a professional apprenticeship.",
  "home.available.history.title": "Salary history",
  "home.available.history.body": "Your salaries year by year, also measured in purchasing power.",
  "home.available.forfettario.title": "Forfettario",
  "home.available.forfettario.body":
    "What is left of your invoices after the flat tax and contributions.",
  "home.available.naspi.title": "NASpI",
  "home.available.naspi.body": "Amount and duration of the unemployment benefit.",
  "home.available.preavviso.title": "Resignation notice",
  "home.available.preavviso.body": "Notice days and leaving date under your collective agreement.",
  "home.available.compoundInterest.title": "Compound interest",
  "home.available.compoundInterest.body":
    "How much capital grows over time, with regular contributions.",
  "home.available.inflation.title": "Purchasing power",
  "home.available.inflation.body":
    "What an amount from a few years ago is worth today, using the ISTAT FOI index.",
  "home.available.glossario.title": "Glossary",
  "home.available.glossario.body": "The terms that show up on a payslip, explained briefly.",
  "home.available.sources.title": "Sources",
  "home.available.sources.body": "The laws and documents the rates come from.",
