...
export const en: Record<MessageKey, string> = {
  ...
  "employee.advanced.title": "Advanced settings",
  "employee.advanced.tabs.label": "Optional sections",
  "employee.advanced.tab.dependents": "Dependents",
  "employee.advanced.tab.expenses": "Expenses",
  "employee.advanced.tab.specialConditions": "Special conditions",
  "employee.advanced.tab.premio": "Performance bonus",
  "employee.advanced.tab.fringe": "Fringe benefits",
  "employee.advanced.municipal": "Municipal addizionale rate",
  "employee.advanced.municipal.lookup": "Look up your rate",
