export const it = {
  ...
  "employee.form.year.hint": "Seleziona l'anno per il calcolo delle imposte.",
  "employee.form.contractType": "Tipo di contratto",
  "employee.form.contractType.indeterminato": "Tempo indeterminato",
  "employee.form.contractType.determinato": "Tempo determinato",
  "employee.form.contractType.apprendistato": "Apprendistato",
  ...
  "compoundInterest.form.annualRate.hint": "Tasso di interesse al lordo dell'inflazione.",
  "compoundInterest.form.years": "Durata",
  "compoundInterest.form.years.unit": "anni",
  "compoundInterest.form.contribution": "Versamento periodico",
  "compoundInterest.form.contribution.hint": "Lascia a zero se non versi nulla.",
  "compoundInterest.form.contributionFrequency": "Frequenza versamento",
  "compoundInterest.form.contributionFrequency.monthly": "Mensile",
  "compoundInterest.form.contributionFrequency.yearly": "Annuale",
  "compoundInterest.form.contributionFrequency.none": "Nessuno",
  "compoundInterest.form.compoundingFrequency": "Capitalizzazione",
  "compoundInterest.form.compoundingFrequency.annually": "Annuale",
  ...
  "naspi.schedule.amountNet": "Netto",
  ...
  "print.section.summary": "Riepilogo",
  "print.section.inputs": "Parametri del calcolo",
  "print.section.breakdown": "Dettaglio del calcolo",
  "print.summary.netAnnual": "Netto annuo",
  "print.summary.netMonthly": "Netto mensile",
  "print.input.gross": "Reddito lordo annuo",
  "print.input.year": "Anno fiscale",
  "print.input.region": "Regione",
  "print.input.municipality": "Aliquota addizionale comunale",
  "print.input.contract": "Tipo di contratto",
  "print.input.frequency": "Mensilità",
  "print.input.companySize": "Dimensione azienda",
  "print.input.publicEmployee": "Settore pubblico",
  "print.input.inpsOverride": "Aliquote INPS personalizzate",
  "print.input.contract.indeterminato": "Tempo indeterminato",
  "print.input.contract.determinato": "Tempo determinato",
  "print.input.contract.apprendistato": "Apprendistato",
  ...
  "print.breakdown.irpefGross": "IRPEF lorda",
  "print.breakdown.totalDeductions": "Detrazioni totali",
  "print.breakdown.irpefNet": "IRPEF netta",
  "print.breakdown.regional": "Addizionale regionale",
  "print.breakdown.municipal": "Addizionale comunale",
  ...
  "history.form.contractType": "Contratto",
  "history.form.paymentFrequency": "Mensilità",
  "history.form.municipalTaxRate": "Aliquota addizionale comunale",
  "history.form.extras": "Altre impostazioni",
  "history.form.dependents.hasSpouse": "Coniuge a carico",
  "history.form.dependents.spouseIncome": "Reddito annuo del coniuge",
  "history.form.dependents.childrenOver21": "Figli a carico oltre i 21 anni",
  "history.form.dependents.otherDependents": "Altri familiari a carico",
  "history.form.companySize": "Dimensione azienda",
  "history.form.companySize.unspecified": "Non specificata",
  "history.form.companySize.small": "Fino a 15 dipendenti",
  "history.form.companySize.large": "Oltre 15 dipendenti",
  "history.form.note": "Nota (opzionale)",
  "history.form.note.hint": "Es. azienda, ruolo, evento di carriera",
  "history.form.submit": "Aggiungi alla cronologia",
  "history.chart.title": "Andamento",
  "history.chart.empty": "Aggiungi almeno una voce per vedere il grafico.",
  "history.chart.aria":
    "Stipendi nel tempo: lordo, netto e proiezione fino al {year}. Naviga con tab per scorrere gli anni.",
  "history.chart.legend.net": "Netto",
  "history.chart.legend.gross": "Lordo",
  "history.chart.legend.projection": "Proiezione",
  "history.chart.hit.aria":
    "{year}: {gross} lordo, {net} netto{projected, plural, =1 { (stimato)} other {}}",
  "history.chart.popover.gross": "Lordo",
  "history.chart.popover.net": "Netto",
  "history.chart.popover.netMonthly": "Netto al mese",
  "history.chart.popover.delta": "{pct} sul {year}",
  "history.chart.popover.projectedTag": "stimato",
  "history.table.title": "Cronologia",
  "history.table.year": "Anno",
  "history.table.gross": "RAL nominale",
  "history.table.net": "Netto",
  "history.table.adjusted": "Rivalutato al {year}",
  "history.table.note": "Nota",
  "history.table.actions": "Azioni",
  "history.table.empty": "Nessuna voce ancora. Aggiungine una usando il modulo qui sopra.",
  "history.table.delete": "Rimuovi",
  "history.table.delete.aria": "Rimuovi la voce del {year}",
  "history.table.adjusted.na": "n/d",
  "history.table.net.na": "n/d",
  "history.table.net.naHint":
    "Per il {year} non abbiamo ancora le regole fiscali. Le aggiungeremo come tassello successivo.",
  "history.table.expand": "Dettagli",
  "history.table.collapse": "Nascondi",
  "history.table.migrated": "Impostazioni stimate",
  "history.table.migrated.hint":
    "Voce salvata prima delle nuove impostazioni. Per personalizzarla, eliminala e inseriscila di nuovo.",
  "history.table.settings.region": "Regione",
  "history.table.settings.contractType": "Contratto",
  "history.table.settings.paymentFrequency": "Mensilità",
  "history.table.settings.municipalTaxRate": "Aliquota comunale",
  "history.table.settings.dependents": "A carico",
  "history.table.settings.dependents.summary":
    "{spouse, plural, =0 {} other {coniuge}} {children, plural, =0 {} =1 {1 figlio oltre 21} other {# figli oltre 21}} {other, plural, =0 {} =1 {1 altro familiare} other {# altri familiari}}",
  "history.table.settings.companySize": "Dimensione azienda",

  "history.projection.title": "Domani",
  "history.projection.lede":
    "Se nulla cambia rispetto al {year} ({gross, number}€ lordi), ecco come potrebbe evolvere il netto.",
  "history.projection.horizonLabel": "Orizzonte",
  ...
  "employee.breakdown.irpefGross": "IRPEF lorda",
  "employee.breakdown.workDeduction": "Detrazione lavoro dipendente",
  "employee.breakdown.dependents": "Detrazione familiari a carico",
  "employee.breakdown.expenses": "Detrazione spese",
  "employee.breakdown.detrazioneAggiuntiva": "Detrazione aggiuntiva (cuneo)",
  "employee.breakdown.impatriati": "Risparmio regime impatriati",
  "employee.breakdown.sommaAggiuntiva": "Somma aggiuntiva (cuneo)",
  "employee.breakdown.totalTaxes": "Totale prelievo fiscale",
  "employee.breakdown.pdrGross": "Premio lordo",
  ...
  "employee.employer.maternity": "Maternità",
  "employee.employer.naspi": "NASpI",
  "employee.employer.naspiAdditional": "Contributo addizionale NASpI",
  ...
  "employee.form.region.hint.deduction": "detrazione {amount} fino a {ceiling}",
