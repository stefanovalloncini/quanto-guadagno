export const it = {
  ...
  "history.chart.aria": "Stipendi nel tempo, in valore nominale e rivalutato al {year}",
  "history.chart.legend.nominal": "Nominale",
  "history.chart.legend.adjusted": "Rivalutato al {year}",
